...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div
      key={project.id}
      className="transition hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:-translate-x-2 hover:-translate-y-2 text-left project-card bg-white border-4 border-black p-4"
    >
      <div className="relative aspect-video w-full bg-gray-200 border-4 border-black mb-4">
        ...
        />
        <p className="absolute uppercase text-white font-black bg-red-400 text-[11px]! -top-1.5 -right-1.5 py-0.5 px-1 border-2 border-black rotate-3">
          {project.type}
        </p>
      </div>
