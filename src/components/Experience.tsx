    ...
    <section className="experience">
      ...
      <article className="card shadow job">
        ...
        <section className="card shadow project">
          ...
          <p>
            Helped lead front-end efforts in developing a scalable platform to
            manage autonomous vehicle hardware and live operations, used by
            control center operators and site managers.
          </p>
      ...
      <article className="card shadow job">
        ...
        <section className="card shadow project">
          ...
          <ul>
            ...
            <li>Designed wireframes and user flows as proof-of-concepts.</li>
            <li>
              Researched and analyzed other Developer Experience/Relation
              programs to learn what makes them tick.
            </li>
            <li>
              Gathered internal data to analyze and determine what the focus of
              the portal would be.
            </li>
            <li>
              Developed a 6 month plan to take the existing documentation site
              and turn it into a developer friendly portal.
            </li>
          </ul>
        </section>
        <section className="card shadow project">
          ...
          <ul>
            ...
            <li>
              Various iterations of this process were built and tested to give
      ...
      <article className="card shadow job">
        ...
        <section className="card shadow project">
          ...
          <ul>
            <li>
              Built a Backbone application that powered a newsfeed in the `My
              Sites`.
            </li>
            <li>
            ...
            <li>
              Increased the use of our <span className="hilite">API</span> to
            ...
            <li>
              Researched and implemented solutions to the mobile version of the
